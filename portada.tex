...
% GRÁFICOS E IMÁGENES
% ========================================
\usepackage{graphicx}               % Inclusión y manipulación de imágenes [draft]-> No inserta las imágenes en el PDF
...
\begin{document}
	...
	\input{Secciones/Anexos/anexoA.tex}	
	
	\chapter{Scripts}
	\input{Secciones/Anexos/anexoB.tex}
